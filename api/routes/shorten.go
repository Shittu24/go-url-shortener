...
import (
	...
	"github.com/shittu24/url-shortener/database"
	"github.com/shittu24/url-shortener/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
	...
	if !helpers.RemoveDomainError(body.URL) {
		return c.Status(fiber.StatusServiceUnavailable).JSON(fiber.Map{
			"error": "haha... nice try but you can't fool me hehehe",
		})
	}
	...
	// if yes, proceed,
	// else, create a new short url using the first 6 digits of uuid
